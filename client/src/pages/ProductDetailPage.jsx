// client/src/pages/ProductDetailPage.jsx (Refactored)
...
const ProductDetailPage = () => {
    ...
    if (loading) {
        return (
            <Container fluid className="py-5 text-center" style={{ minHeight: "80vh" }}>
    ...
    if (error) {
        return (
            <Container fluid className="py-5 text-center">
                ...
                <Button as={Link} to="/">Quay về Trang chủ</Button>
            </Container>
        );
    }
            ...
            <Row className="g-5">
                ...
                <Col lg={7} md={6}>
                    <ProductGallery
                        ...
                        onPrev={() => setCurrentImageIndex((prev) => (prev - 1 + product.HinhAnh.length) % product.HinhAnh.length)}
                        onNext={() => setCurrentImageIndex((prev) => (prev + 1) % product.HinhAnh.length)}
                    />
                </Col>
            ...
            <Row className="mt-5">
                <Col>
                    <div className="product-tabs-premium">
                        <Tabs defaultActiveKey="description" id="product-tabs" className="mb-3 justify-content-center" justify>
                            <Tab eventKey="description" title="MÔ TẢ CHI TIẾT">
                                <div className="product-description-content" dangerouslySetInnerHTML={{ __html: product.MoTa }} />
                            </Tab>
