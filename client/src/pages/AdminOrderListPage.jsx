// client/src/pages/AdminOrderListPage.jsx (Refactored)
...
const AdminOrderListPage = () => {
    ...
    const confirmStatusUpdate = async () => {
        ...
        await updateOrderStatus(pendingStatusUpdate.orderId, pendingStatusUpdate.newStatus);
    ...
    return (
        <AdminLayout>
            ...
            <ConfirmStatusModal
                ...
                message={
                    pendingStatusUpdate
                        ? `Bạn có chắc muốn chuyển đơn hàng #${pendingStatusUpdate.orderId} sang trạng thái "${getStatusName(pendingStatusUpdate.newStatus)}"?`
                        : ""
                }
